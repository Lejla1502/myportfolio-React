...
import L_CERT from "../../assets/img/skills/cert.png";
...
export const skills={
    ...
    hostingPlatforms: [
        ...
        },
        {
          ...
          imgAltText: "Plesk Obsidian",
          imgSrc: L_PLESK,
          skillName: "Plesk Obsidian",
        },
        {
      ...
      certificate: [
        ...
        {
          link: "https://www.freecodecamp.org/certification/lejlasp/responsive-web-design",
