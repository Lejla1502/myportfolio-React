    ...
    return(
        <div className="pt-3 pb-3" id="skills">
          ...
          <CardDeck>
            ...
            {/*for changing number of columns */}
            <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2 ">
              <Card.Body>
                <Card.Title className="text-center  card-title">Certificate</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.certificate.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-dark text-decoration-none" href={skill.link} target="_blank" rel="noopener noreferrer">
                        <Image src={skill.imgSrc} alt={skill.imgAltText} rounded className="image-cert-style "></Image> 
                      </a>
                    </span>
                  ))}
                </Card.Text>
                  ...
                  {skills.databases.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-dark text-decoration-none" href={skills.databases[0].link} target="_blank" rel="noopener noreferrer">
                        <Image src={skill.imgSrc} alt={skills.databases[0].imgAltText} rounded className="image-style m-1"></Image> {skill.skillName}
                      </a>
                    </span>
                  ))}
                </Card.Text>
